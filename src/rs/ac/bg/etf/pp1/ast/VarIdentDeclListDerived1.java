...
public class VarIdentDeclListDerived1 extends VarIdentDeclList {

    private VarIdentDeclList VarIdentDeclList;
    private String i;

    public VarIdentDeclListDerived1 (VarIdentDeclList VarIdentDeclList, String i) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarIdentDeclListDerived1(\n");
