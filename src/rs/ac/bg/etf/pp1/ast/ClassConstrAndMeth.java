...
public class ClassConstrAndMeth extends ClassMethods {

    private ConstructorDecl ConstructorDecl;
    private MethodDeclList MethodDeclList;

    public ClassConstrAndMeth (ConstructorDecl ConstructorDecl, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassConstrAndMeth(\n");
