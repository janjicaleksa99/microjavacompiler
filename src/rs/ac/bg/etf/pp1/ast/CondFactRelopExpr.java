...
public class CondFactRelopExpr extends CondFact {

    private Expression Expression;
    private Relop Relop;
    private Expression Expression1;

    public CondFactRelopExpr (Expression Expression, Relop Relop, Expression Expression1) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CondFactRelopExpr(\n");
