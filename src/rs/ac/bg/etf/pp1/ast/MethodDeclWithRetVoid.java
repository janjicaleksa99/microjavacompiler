...
public class MethodDeclWithRetVoid extends MethodDecl {

    private MethodVoidName MethodVoidName;
    private VarDeclList VarDeclList;
    private Statements Statements;

    public MethodDeclWithRetVoid (MethodVoidName MethodVoidName, VarDeclList VarDeclList, Statements Statements) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclWithRetVoid(\n");
