...
public class BoolConstIdentDeclList extends ConstIdentDeclList {

    private ConstIdentDeclList ConstIdentDeclList;
    private String constName;
    private Boolean bool_Const;

    public BoolConstIdentDeclList (ConstIdentDeclList ConstIdentDeclList, String constName, Boolean bool_Const) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("BoolConstIdentDeclList(\n");
