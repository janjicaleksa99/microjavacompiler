...
public class CharConstIdentDeclList extends ConstIdentDeclList {

    private ConstIdentDeclList ConstIdentDeclList;
    private String constName;
    private Character charConst;

    public CharConstIdentDeclList (ConstIdentDeclList ConstIdentDeclList, String constName, Character charConst) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("CharConstIdentDeclList(\n");
