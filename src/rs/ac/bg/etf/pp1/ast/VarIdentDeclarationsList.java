...
public class VarIdentDeclarationsList extends VarIdentDeclList {

    private VarIdentDeclList VarIdentDeclList;
    private String varName;

    public VarIdentDeclarationsList (VarIdentDeclList VarIdentDeclList, String varName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarIdentDeclarationsList(\n");
